  ...
  return (
    <section className="py-12 border-y border-[var(--border-color)]/60 bg-[var(--bg-card)]/30 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <p className="text-center text-xs font-bold uppercase tracking-widest text-[var(--color-gray-muted)] mb-8">
        ...
        <div className="relative w-full overflow-hidden flex">
          ...
          <div className="animate-marquee flex items-center gap-16 py-2">
            {doubleCompanies.map((company, index) => (
              ...
              >
                <span className="text-lg md:text-xl font-bold tracking-wider text-[var(--color-slate)]/50 hover:text-[var(--color-primary)] transition-colors duration-300 font-sans cursor-pointer">
                  {company}
                </span>
              </div>
            ))}
